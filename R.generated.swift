...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    /// Resource file `column@2x.png`.
    static let column2xPng = Rswift.FileResource(bundle: R.hostingBundle, name: "column@2x", pathExtension: "png")
    /// Resource file `defaultAvatar@2x.png`.
    static let defaultAvatar2xPng = Rswift.FileResource(bundle: R.hostingBundle, name: "defaultAvatar@2x", pathExtension: "png")
    ...
    /// `bundle.url(forResource: "column@2x", withExtension: "png")`
    static func column2xPng(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.column2xPng
      return fileResource.bundle.url(forResource: fileResource)
    }

    /// `bundle.url(forResource: "defaultAvatar@2x", withExtension: "png")`
    static func defaultAvatar2xPng(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.defaultAvatar2xPng
      return fileResource.bundle.url(forResource: fileResource)
    }
  ...
  struct image {
    ...
    /// Image `column`.
    static let column = Rswift.ImageResource(bundle: R.hostingBundle, name: "column")
    /// Image `defaultAvatar`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "column", bundle: ..., traitCollection: ...)`
    static func column(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.column, compatibleWith: traitCollection)
    }
    #endif
